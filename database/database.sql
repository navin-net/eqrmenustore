...
(1208, 'would_you_like_to_clear_the_cart', 'admin', 'Would you like to clear the cart?', 'Would you like to clear the cart?', 'هل ترغب في مسح سلة التسوق؟', '¿Le gustaría borrar el carrito?', 'Хотите очистить корзину?', '您想清空购物车吗？', 'Voulez-vous vider le panier ?', 'Deseja limpar o carrinho?', 'क्या आप गाड़ी साफ़ करना चाहेंगे?'),
(1210, 'default_language', 'admin', 'Default Language', 'Default Language', 'اللغة الافتراضية', 'Idioma predeterminado', 'Язык по умолчанию', '默认语言', 'Langue par défaut', 'Idioma padrão', 'डिफ़ॉल्ट भाषा'),
(1211, 'site_language', 'admin', 'Site Language', 'Site Language', 'لغة الموقع', 'Idioma del sitio', 'Язык сайта', '站点语言', 'Langue du site', 'Idioma do Site', 'साइट भाषा'),
(1212, 'google_translator', 'admin', 'Google translator', 'Google translator', 'مترجم جوجل', 'Traductor de Google', 'Google переводчик', '谷歌翻译', 'Traducteur Google', 'Google tradutor', 'गूगल अनुवादक'),
(1213, 'system_language', 'admin', 'System Language', 'System Language', 'لغة النظام', 'Idioma del sistema', 'Язык системы', '系统语言', 'Langue du système', 'Idioma do Sistema', 'सिस्टम भाषा'),
(1214, 'todays_orders', 'admin', 'Today\'s orders', 'Today\'s orders', 'طلبات اليوم', 'Pedidos de hoy', 'Сегодняшние заказы', '今日订单', 'Commandes du jour', 'Pedidos de hoje', 'आज के ऑर्डर'),
(1215, 'draft', 'admin', 'Draft', 'Draft', 'مسودة', 'Borrador', 'Черновик', '草稿', 'Brouillon', 'Rascunho', 'ड्राफ्ट'),
(1216, 'all_categories', 'admin', 'All Categories', 'All Categories', 'جميع الفئات', 'Todas las categorías', 'Все категории', '所有类别', 'Toutes les catégories', 'Todas as categorias', 'सभी श्रेणियाँ'),
(1217, 'save_and_new_order', 'admin', 'Save and new order', 'Save and new order', 'حفظ وترتيب جديد', 'Guardar y nuevo pedido', 'Сохранить и создать новый заказ', '保存并新订单', 'Enregistrer et nouvelle commande', 'Salvar e novo pedido', 'सहेजें और नया ऑर्डर करें'),
(1218, 'add_variants', 'admin', 'Add Variants', 'Add Variants', 'إضافة متغيرات', 'Agregar variantes', 'Добавить варианты', '添加变体', 'Ajouter des variantes', 'Adicionar variantes', 'वेरिएंट जोड़ें'),
(1219, 'select_category', 'admin', 'Select Category', 'Select Category', 'اختر فئة', 'Seleccionar categoría', 'Выбрать категорию', '选择类别', 'Sélectionner une catégorie', 'Selecionar categoria', 'श्रेणी चुनें'),
(1220, 'variant_name', 'admin', 'Variant Name', 'Variant Name', 'اسم البديل', 'Nombre de variante', 'Название варианта', '变体名称', 'Nom de la variante', 'Nome da Variante', 'संस्करण का नाम'),
(1221, 'login_btn_in_menu', 'admin', 'Login button in menu bar', 'Login button in menu bar', 'زر تسجيل الدخول في شريط القائمة', 'Botón de inicio de sesión en la barra de menú', 'Кнопка входа в строку меню', '菜单栏中的登录按钮', 'Bouton de connexion dans la barre de menu', 'Botão Login na barra de menu', 'मेनू बार में लॉगिन बटन'),
(1222, 'new_cart', 'admin', 'New Cart', 'New Cart', 'عربة التسوق الجديدة', 'Nuevo carrito', 'Новая корзина', '新购物车', 'Nouveau panier', 'Novo carrinho', 'नई गाड़ी'),
(1223, 'show_in_menu_bar', 'admin', 'Show in Menu bar', 'Show in Menu bar', 'عرض في شريط القائمة', 'Mostrar en la barra de menú', 'Показать в строке меню', '在菜单栏中显示', 'Afficher dans la barre de menu', 'Mostrar na barra de menu', 'मेनू बार में दिखाएँ'),
(1224, 'question_list', 'admin', 'Question List', 'Question List', 'قائمة الأسئلة', 'Lista de preguntas', 'Список вопросов', '问题列表', 'Liste de questions', 'Lista de Perguntas', 'प्रश्न सूची'),
(1225, 'reject_reasons', 'admin', 'Reject Reasons', 'Reject Reasons', 'أسباب الرفض', 'Motivos del rechazo', 'Причины отклонения', '拒绝原因', 'Raisons du rejet', 'Motivos de rejeição', 'कारणों को अस्वीकार करें'),
(1226, 'reason_list', 'admin', 'Reason List', 'Reason List', 'قائمة الأسباب', 'Lista de motivos', 'Список причин', '原因列表', 'Liste des raisons', 'Lista de Razões', 'कारण सूची'),
(1227, 'add_reason', 'admin', 'Add Reason', 'Add Reason', 'إضافة سبب', 'Agregar motivo', 'Добавить причину', '添加原因', 'Ajouter une raison', 'Adicionar Motivo', 'कारण जोड़ें'),
(1228, 'order_reject', 'admin', 'Order Reject', 'Order Reject', 'رفض الطلب', 'Pedido Rechazado', 'Отказ от заказа', '订单拒绝', 'Commande rejetée', 'Pedido rejeitado', 'आदेश अस्वीकार'),
(1229, 'access_for', 'admin', 'Access for', 'Access for', 'الوصول لـ', 'Acceso para', 'Доступ для', '访问', 'Accès pour', 'Acesso para', 'पहुँच के लिए'),
(1230, 'delivery_guy', 'admin', 'Delivery Guys', 'Delivery Guys', 'رجال التوصيل', 'Repartidores', 'Доставщики', '送货员', 'Les livreurs', 'Entregadores', 'डिलीवरी गाईज़'),
(1231, 'created_by', 'admin', 'Created by', 'Created by', 'تم الإنشاء بواسطة', 'Creado por', 'Разработал', '创建者', 'Créé par', 'Criado por', 'द्वारा निर्मित'),
(1232, 'branding', 'admin', 'Branding', 'Branding', 'العلامة التجارية', 'Marca', 'Брендинг', '品牌', 'Marque', 'Marca', 'ब्रांडिंग'),
(1233, 'tutorials', 'admin', 'Tutorials', 'Tutorials', 'البرامج التعليمية', 'Tutoriales', 'Учебники', '教程', 'Tutoriels', 'Tutoriais', 'ट्यूटोरियल'),
(1234, 'page_title', 'admin', 'Page Titles', 'Page Titles', 'عناوين الصفحات', 'Títulos de página', 'Названия страниц', '页面标题', 'Titres des pages', 'Títulos de páginas', 'पेज शीर्षक'),
(1235, 'dboy', 'admin', 'Delivery Guys', 'Delivery Guys', 'رجال التوصيل', 'Repartidores', 'Доставщики', '送货员', 'Les livreurs', 'Entregadores', 'डिलीवरी गाईज़'),
(1236, 'whatsapp_support', 'admin', 'WhatsApp support', 'WhatsApp support', 'دعم الواتساب', 'Soporte de WhatsApp', 'Поддержка WhatsApp', 'WhatsApp 支持', 'Support WhatsApp', 'Suporte WhatsApp', 'व्हाट्सएप समर्थन'),
(1237, 'support_until', 'admin', 'Support Until', 'Support Until', 'الدعم حتى', 'Soporte hasta', 'Поддержка до', '支持直到', 'Support jusqu\'à', 'Suporte até', 'जब तक समर्थन करें'),
(1238, 'template', 'admin', 'Template', 'Template', 'القالب', 'Plantilla', 'Шаблон', '模板', 'Modèle', 'Modelo', 'टेम्पलेट');
