		...
		<div class="col-md-6">
			<div class="d_single_order_area">
				<div class="d_single_order_header">
					...
					<?php if($order_info['dboy_status']==0 ||$order_info['dboy_status']==1 || ($order_info['dboy_status']==1 && $order_info['is_db_accept']==1)): ?>
						<div class="rightBtn">
							<a href="javascript:;" data-url="<?= base_url('staff/cancel_order/'.$order_info['uid'].'/'.auth('staff_id')); ?>" class="btn btn-danger dboyCancelBtn rejectModal"> <i class="icofont-close"></i>  <?= !empty(lang('cancel'))?lang('cancel'):"cancel"; ?></a>
						</div>
					<?php endif; ?>

					<?php if($order_info['dboy_status']==4 ||$order_info['status']==3): ?>
						<div class="rightBtn">
							<a href="javascript:;" class="btn btn-danger dboyCancelBtn"> <i class="icofont-close"></i>  <?= !empty(lang('canceled'))?lang('canceled'):"canceled"; ?></a>
						</div>
					<?php endif; ?>
