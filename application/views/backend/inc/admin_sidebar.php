...
<!-- Affiliate -->
<li class="treeview hidden <?= isset($page) && $page=="Affiliate"?"active":"";?>">
    <a href="#">
        <i class="icofont-addons fz-20"></i>
    ...
    <ul class="treeview-menu">
        ...
        <li class="<?= $page_title =="Affiliate Settings"?"active":"";?>">
            <a href="<?= base_url('admin/affiliate/') ?>">
                <i class="fa fa-angle-double-right"></i> <span><?= !empty(lang('settings'))?lang('settings'):"Settings";?></span>
            </a>
        </li>
        ...
        <li class="<?= $page_title =="Payout Request"?"active":"";?>">
         ...
         <li class="<?= $page_title =="Payout Completed"?"active":"";?>">
            <a href="<?= base_url('admin/affiliate/payout_completed') ?>">
                <i class="fa fa-angle-double-right"></i> <span><?= lang('payout_completed');?></span>
            </a>
        </li>
 	...
 	<ul class="treeview-menu">
        ...
        <li class="<?= $page_title =="Tutorials"?"active":"";?>">
            <a href="<?= base_url('admin/home/tutorials') ?>">
                <i class="icofont-substitute"></i> <?= lang('tutorials');?> <span><?= is_new('3.1.6');?></span>
            </a>
        </li>
