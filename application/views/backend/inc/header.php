...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url()?>public/admin/responsive.css?v=<?= $settings['version'];?>&time=<?= time();?>">
   <?php if(direction()=='rtl'): ?>
...
<?php else: ?>
  ...
  <body class="hold-transition <?= isset($user_settings['site_theme']) && $user_settings['site_theme']==1?"skin-black-light":"skin-black";?> sidebar-mini   <?= isset($page) && $page=="POS"?"sidebar-collapse":'';?>">
<?php endif ?>
