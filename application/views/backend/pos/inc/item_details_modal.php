			 		...
			 		<div class="mt-10 slots_area details_price">
			 			...
			 			<?php if(isset($price->variant_name) && !empty($price->variant_name)): ?>
			                <?php foreach ($price->variant_options as $key => $value):?>
			                  <label class="single_slots getPrice" data-price="<?= $value->price;?>">
			               				<?= $value->name;?>
			               				<input type="radio" name="size_price" class="checked_values" value="<?= $value->price;?>">
			               				<input type="radio" name="size_slug" class="checked_values" value="<?= $value->slug;?>">
