						...
						<div class="col-md-12">
							<div class="form-group col-md-4 pl-0">
								...
								<select name="language_type" id="language_type" class="form-control" onchange="changeLang(this.value)">
									<option value="system" <?= isset($language_type) && $language_type=="system"?"selected":"";?> selected><?= lang('system_language');?></option>
									<option value="google" <?= isset($language_type) && $language_type=="google"?"selected":"";?>><?= lang('google_translator');?></option>
								</select>
							</div>
						</div>
						<div class="languageItems system mt-10 <?= isset($language_type) && $language_type=="system"?"":"dis_none";?>">
							<div class="col-md-12 ">
								<div class="form-group">
