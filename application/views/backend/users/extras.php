                       ...
                       <div class="row">
                            <div class="form-group col-md-4">
                                <select name="language_type" id="language_type" class="form-control" onchange="changeLang(this.value)">
                                    <option value="system" <?= isset($apps->language_type) && $apps->language_type=="system"?"selected":"";?> selected><?= lang('system_language');?></option>
                                    <option value="google" <?= isset($apps->language_type) && $apps->language_type=="google"?"selected":"";?>><?= lang('google_translator');?></option>
                                </select>
                            </div>
                       </div>
