				...
				<div class="card-body">
						...
						<div class="custom-control  orderConfig custom-switch prefrence-item ml-10">
							<div class="gap">
								...
								<label for="is_login" class="switch-label"> <span class="toggle--on"> <i class="fa fa-check c_green"></i> <?= !empty(lang('on'))?lang('on'):"On";?></span><span class="toggle--off"><i class="fa fa-ban c_red"></i> <?= !empty(lang('off'))?lang('off'):"Off";?></span></label>

							</div>
							<div class="preText">
								<div class="">
									<label class="custom-control-label"><?= !empty(lang('login_btn'))?lang('login_btn'):'Login Button' ;?> </label>
									
									<p class="text-muted"><small><?= !empty(lang('login_btn_in_menu'))?lang('login_btn_in_menu'):"Login button in menu bar"; ?></small></p>
								</div>
