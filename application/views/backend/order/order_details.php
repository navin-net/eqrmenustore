							...
							<div class="mt-20 orderBtnList">
								<?php if($order['status']==0): ?>
									...
									<?php if(is_access('order-cancel')==1): ?>
										<a href="javascript:;" data-url="<?= base_url('admin/restaurant/order_status/'.$order['uid']).'/3' ;?>" data-ajax="0" class="btn danger-light rejectModal" data-toggle="tooltip" title="Mark as Cancel"><i class="icofont-hand-drag1"></i> &nbsp; <?= lang('cancel'); ?> </a> &nbsp;
									<?php endif; ?>
