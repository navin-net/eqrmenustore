			...
			<form action="" method="get" class="filterForm">
				<div class="filterBody">
					...
					<div class="form-group">
						...
						<option value="pending" <?= isset($_GET['status']) && $_GET['status']=="pending"?"selected":'' ;?>><?= lang('pending'); ?></option>
							<option value="accepted" <?= isset($_GET['status']) && $_GET['status']=="accepted"?"selected":'' ;?>><?= lang('accepted'); ?></option>
							<option value="completed" <?= isset($_GET['status']) && $_GET['status']=="completed"?"selected":'' ;?>><?= lang('completed'); ?></option>
							<option value="rejected" <?= isset($_GET['status']) && $_GET['status']=='rejected'?"selected":'' ;?>><?= lang('rejected'); ?></option>
						</select>
					</div>
	...
	<div class="row">
		<div class="col-md-12">	
			<div class="card orderListCard">
				<div class="card-header flex space-between p-10 p-r">
					<div class="cardTop">
					...
					<div class="orderList">
						<ul class="viewContent">
							<?php if(file_exists(APPPATH.'controllers/admin/Pos.php')): ?>
								<li><a href="<?= base_url("admin/pos");?>"  class="btn btn-secondary mr-5"><i class="fa fa-plus"></i> New order</a></li>
							<?php endif; ?>
