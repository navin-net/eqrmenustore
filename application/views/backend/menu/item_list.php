    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Info</h4>
	      ...
	      <div class="modal-body">
	      	<ol class="infoUl">
	      		<li><span>Image / thumb : </span>  <p>uploaded image path in this script</p></li>
	      		<li><span>is_feature : </span>  <p>1 = show in home page / landing page.</p> </li>
	      		<li><span>veg_type : </span> <p> 1 = veg; 2 = non veg; 0 = none;</p>   </li>
	      		<li><span>img_type : </span> <p>1 = if image is uploaded in this script; 2 = link from others sites</p>  </li>
	      		<li><span>img_url : </span> <p>Extanal image link</p> </li>
	      	</ol>
