		...
		<div class="card">
			<div class="card-header space-between">
				...
				<div class="box-tools pull-right">
					<?php if(st()->language==site_lang()): ?>
						<?php if(isset($active) && $active==1): ?>
							<?php if(is_access('add')==1): ?>
								<a href="<?= base_url('admin/menu/create_specialties') ;?>" class="btn btn-secondary "><i class="fa fa-plus"></i> &nbsp;<?= !empty(lang('add_new'))?lang('add_new'):"Add New";?> </a>
							<?php endif; ?>
						<?php endif;?>
					<?php endif;?>
				</div>
