                    ...
                    <?php if ($shop['is_language']==1) : ?>
                        ...
                        <?php else : ?>
                            <?php if (sizeof($language) > 1) : ?>
                                <li class="dropdownMenu"><a class="nav-link p-r" href="javascript:;" ><i class="icofont-globe"></i> <span class=""><?= lang_slug(!empty(auth('site_lang'))?auth('site_lang'):$settings['language']) ;?></span></a>
                    ...
                    <div class="container-fluid">
                        <div class="userMenu_flex">
                            ...
                            <?php if(sizeof($page_list) >0): ?>
                                <li class="dropdownMenu dropDown nav-item"><a href="javascript:;" class="nav-link"><?= lang('pages') ;?> <i class="icofont-rounded-down"></i></a>
                                    ...
                                    <?php if ($shop['is_language']==1) : ?>
                                        ...
                                        <?php else : ?>
                                            <?php if (count($language) > 1) : ?>
                                                <li class="dropdownMenu"><a class="nav-link p-r btn" href="javascript:;" ><i class="icofont-globe"></i> <?= lang_slug(!empty(auth('site_lang'))?auth('site_lang'):$settings['language']) ;?></a>
                                                    <div class="dropdownArea dropdownList" style="display: none;">
                                                        <ul>
                                                            <?php foreach ($language as $ln) : ?>
                                                                    <li><a href="<?= base_url('home/lang_switch/'.$ln->slug) ;?>"><?= $ln->lang_name;?></a></li>
...
<div class="UserResponsive_menu">
    <div class="UserMobileMenu">
        <ul>
            ...
            <li data-toggle="tooltip" title=""><a href="javascript:;" class="base"><i class="icofont-navigation-menu"></i></a></li>
    ...
    <div class="show_menu_details">
        ...
        <?php endif ?>
         ...
         <?php endif ?>
            ...
            <?php else: ?>
                <?php if ($shop['is_language']==1) : ?>
                    <li class="dropdownMenu allow-sm"><a class="nav-link p-r" href="javascript:;" ><i class="icofont-globe"></i> <?= lang_slug(!empty(auth('site_lang'))?auth('site_lang'):$settings['language']) ;?></a>
                        <div class="dropdownArea dropdownList" style="display: none;">
                            <ul>
                                <?php foreach ($language as $ln) : ?>
                                    <li><a href="<?= base_url('home/lang_switch/'.$ln->slug) ;?>"><?= $ln->lang_name;?></a></li>
            ...
            <li><a href="<?= base_url("staff-login/customer");?>"><i class="icofont-sign-in"></i> <?= lang('login'); ?></a></li>
      
            <?php if(sizeof($page_list) >0): ?>                
                <li class="dropdownMenu allow-sm"><a class="nav-link p-r" href="javascript:;" ><i class="icofont-copy"></i> <?= lang("pages") ;?></a>
                    <div class="dropdownArea dropdownList" style="display: none;">
                        <ul>
                             <?php foreach ($page_list as $key => $pg): ?>
                                <li><a href="<?= url('page/'.$slug.'/'.$pg->slug) ;?>"><?= $pg->title; ?></a></li>
                            <?php endforeach ?>
                        </ul>
                    </div>
                </li>
