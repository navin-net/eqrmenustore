...
public function count_total_user()
{
   ...
   public function get_all_items_by_user($id,$limit=0,$product_limit=8)
    {
  ...
  public function get_my_page_by_slug($slug,$shop_id)
  {
  	...
  	$this->db->where('v.language',$this->site_lang);
  	$query = $this->db->get();
  	if($query->num_rows() > 0)
	  	$query =  $query->row();
	  else{
  ...
  public function get_my_page_by($shop_id,$type='menubar')
  {
